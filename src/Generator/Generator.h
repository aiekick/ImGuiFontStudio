...
enum _GenModeFlags
{
	...
	GENERATOR_MODE_HEADER_FILE = (1 << 0),
	GENERATOR_MODE_HEADER_PICTURE = (1 << 1),
	GENERATOR_MODE_HEADER = GENERATOR_MODE_HEADER_FILE | GENERATOR_MODE_HEADER_PICTURE,
	GENERATOR_MODE_FONT = (1 << 2),
	GENERATOR_MODE_CPP = (1 << 3),
	...
	GENERATOR_MODE_HEADER_SETTINGS_ORDER_BY_NAMES = (1 << 8),
	GENERATOR_MODE_HEADER_SETTINGS_ORDER_BY_CODEPOINT = (1 << 9),
...
{
private:
	HeaderPictureGenerator m_HeaderPictureGenerator;
