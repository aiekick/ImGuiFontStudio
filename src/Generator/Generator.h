...
enum _GenModeFlags
{
	...
	GENERATOR_MODE_LANG_C = (1 << 11),
	GENERATOR_MODE_LANG_CPP = (1 << 12),
	GENERATOR_MODE_LANG_CSHARP = (1 << 13),
	GENERATOR_MODE_RADIO_LANG = GENERATOR_MODE_LANG_C | GENERATOR_MODE_LANG_CPP | GENERATOR_MODE_LANG_CSHARP,
	GENERATOR_MODE_HEADER_CARD = GENERATOR_MODE_HEADER | GENERATOR_MODE_CARD,
	GENERATOR_MODE_RADIO_FONT_CPP = GENERATOR_MODE_FONT | GENERATOR_MODE_SRC, // for radio widgets
	...
	GENERATOR_MODE_CURRENT_CPP = GENERATOR_MODE_CURRENT | GENERATOR_MODE_SRC,
	...
	GENERATOR_MODE_BATCH_CPP = GENERATOR_MODE_BATCH | GENERATOR_MODE_SRC,
	...
	GENERATOR_MODE_MERGED_CPP = GENERATOR_MODE_MERGED | GENERATOR_MODE_SRC,
